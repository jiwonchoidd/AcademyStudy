...
public:
	...
	D3DXMATRIX			m_matView;
	D3DXMATRIX			m_matProj;
	void				SetMatrix(D3DXMATRIX& matWorld,D3DXMATRIX& matView, D3DXMATRIX& matPro );
	TDxBuffer			m_VB;
	TDxBuffer			m_IB;	
	TDxBuffer			m_CB;
...
class TLineAxisShape : public TShape
{
public:
	bool		Create(ID3D11Device* pd3dDevice,
		ID3D11DeviceContext*	pImmediateContext,
