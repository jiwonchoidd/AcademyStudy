...
list<int> Account::GetHistory() { return history_; }

string Account::GetCustomerName() { return customerName_; }
...
void PassbookAccount::Accept(Reporter& rpt) 
{
	rpt.VisitPassbookAccount(this);
}

int PassbookAccount::GetTotalSum() 
{
...
void CheckingAccount::Accept(Reporter& rpt) 
{
	rpt.VisitCheckingAccount(this);
}

int CheckingAccount::GetTotalSum() 
{
