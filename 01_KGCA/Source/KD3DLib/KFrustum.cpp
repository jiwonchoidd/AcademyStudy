...
void KFrustum::CreateFrustum(KMatrix& matView, KMatrix& matProj)
{
	...
	m_Plane[1] = KPlane(m_Frustum[4], m_Frustum[6], m_Frustum[7]);	//+z 뒷면

	m_Plane[2] = KPlane(m_Frustum[1], m_Frustum[3], m_Frustum[7]);	//+x 오른쪽

	m_Plane[3] = KPlane(m_Frustum[4], m_Frustum[6], m_Frustum[2]);	// -x 왼쪽

	m_Plane[4] = KPlane(m_Frustum[2], m_Frustum[6], m_Frustum[7]);	//+y 윗쪽

	m_Plane[5] = KPlane(m_Frustum[0], m_Frustum[4], m_Frustum[5]);	//-y 아랫쪽
